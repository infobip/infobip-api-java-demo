...
public class SendSmsAdapter {
    ...
    /**
     * Id of the group of statuses representing an accepted sms message.
     * Message in a status belonging to this group is considered to be accepted for processing
     * by the Infobip API without errors. It is properly formatted and has all the necessary fields.
    ...
    /**
     * Id of the group of statuses representing an sms messages pending processing.
     * Message in a status belonging to this group is waiting to be processed either by the Infobip
    ...
    /**
     * Id of the group of statuses representing a delivered sms message.
    ...
    /**
     * Id of the group of statuses representing an undeliverable sms message.
    ...
    /**
     * Id of the group of statuses a representing expired sms message.
     * If sms sending fails at first Infobip platform will continue to retry sending it for a period of time.
     * As sending is dependant on conditions that might change (for example sms recipient might have her phone
    ...
    /**
     * Id of the group of statuses representing a rejected sms message.
     * Message might end up in rejected status for several reasons. For starters the message itself might
     * have invalid properties. For example, messages sent to phone numbers in wrong format will be rejected.
     * Statuses representing missing network or country prefixes both fall into this group. Additionally,
    ...
    public Sms sendSms(Sms sms) {
        ...
        try {
            ...
            tuned status handling individual ids can be used.
             */
            ...
            switch (status.getGroupId()) {
                ...
                case STATUS_GROUP_DELIVERED:
                    /*
                    All of the success statuses are handled the same way by creating a domain model representing
         ...
         */
            ...
            way root cause of the exception is preserved but this method will throw expected exception types.
             */
